...
📚 Stack: **PowerShell, .NET, COM, WMI/CIM, GUI WinForms, REST API, IE/Selenium, JSON, XML, Excel, AD, EMShell, PowerCLI, Veeam, Zabbix, InfluxDB, Grafana, MSSQL, MySQL, DSC, Ansible, Jenkins, Git, Python, TKInter.** \
